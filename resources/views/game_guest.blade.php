...
<body id="bg" class="min-vh-100 min-vw-100 d-flex justify-content-center align-items-center">
        ...
        <div class="container-fluid w-100 bg-dark">
            <div class="d-flex justify-content-between w-100">
                <div class="navbar-brand d-flex justify-content-between align-items-center m-0">
                    <buttom class="btn btn-outline-light p-2 m-2" id="seeding"style="display: none;"><img src="images/seeding.png"
                            class="img-fluid max-height-64" alt="seeding"></buttom>
                    <buttom class="btn btn-outline-light p-2 m-2" id="mission"style="display: none;"><img src="images/target.png"
                            class="img-fluid max-height-64" alt="target"></buttom>
                    <buttom class="btn btn-outline-light p-2 m-2" id="change-type" onclick="changeGameMode()"style="display: none;"><img
                            src="images/exchange.png" class="img-fluid max-height-64" alt="change-type-icon"></buttom>
                    <buttom class="btn btn-outline-light p-2 m-2" id="setting"style="display: none;"><img
                            src="images/settings-icon.png" class="img-fluid max-height-64" alt="settings"></buttom>
                    <a href="{{route('friends')}}" class="btn btn-primary">Friends</a>
                </div>
                <div class="navbar-brand d-flex justify-content-center align-items-center m-0">
                    <img src="images/coin-icon.png" alt="coin-icon" width="64" height="64"style="display: none;">
                    <span id="coins" class="mx-2"style="display: none;"></span>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="position-absolute w-auto mx-3 p-3 bg-dark bg-opacity-50 text-bg-dark overflow-auto d-flex flex-column align-items-center px-5 shadow window"
        id="window-seeding" style="display: none;">
    ...
    <!--WINDOW MISSION-->
    <div class="position-absolute w-auto mx-3 p-3 bg-dark bg-opacity-50 text-bg-dark overflow-auto d-flex flex-column align-items-center px-5 shadow window"
        id="window-mission" style="display: none;">
        <div class="w-100 text-center my-3">
            <h2>Missions</h2>
        </div>
    ...
    <!--WINDOW SETTINGS-->
    <div class="position-absolute w-auto mx-3 p-3 bg-dark bg-opacity-50 text-bg-dark overflow-auto d-flex flex-column align-items-center px-5 shadow window"
        id="window-settings" style="display: none;">
        <div class="w-100 text-center my-3">
            <h2>Settings</h2>
        </div>
        <div class="container">
    ...
    <!--BOTTOM NAV-->
    <nav class="navbar fixed-bottom navbar-expand-sm navbar-dark bg-dark" id="navbot" style="display: none;">
